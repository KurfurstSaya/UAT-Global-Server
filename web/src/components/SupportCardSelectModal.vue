  ...
  data() {
    return {
      umamusumeSupportCardList: [
        ...
        {id:10014, name:'被授予魔力的英雄', desc:'Zenno Rob Roy'},
        ...
        {id:20008, name:'樱花盛开之时', desc:'Sakura Chiyono O'},
        {id:20009, name:'43、8、1', desc:'Nakayama Festa'},
        {id:20010, name:'全力嬉闹！', desc:'Winning Ticket'},
        ...
        {id:30006, name:'梦想真的可以实现！', desc:'Winning Ticket'},
        {id:30007, name:'幸福就在转角后', desc:'Rice Shower'},
        {id:30008, name:'Head-on fight！', desc:'Bamboo Memory'},
        {id:30009, name:'Trifle Vacation', desc:'Daiwa Scarlet'},
        {id:30010, name:'起舞今宵', desc:'King Halo'},
        ...
        {id:40008, name:'请品尝第一口！', desc:'Hishi Akebono'},
        {id:40009, name:'爽快！决胜一击！', desc:'Mejiro Ryan'},
        ...
        {id:50004, name:'心与心愿', desc:'Mejiro Dober'},
        {id:50005, name:'即使满身泥土，也要追逐梦想', desc:'Nice Nature'},
        {id:50006, name:'明天全国都会染红吧', desc:'Seiun Sky'},
        {id:50007, name:'幽灵小姐与万圣节的魔法', desc:'Mihono Bourbon'},
        {id:50008, name:'可爱的你，美丽的你', desc:'Curren Chan'},
